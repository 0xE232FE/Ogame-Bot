...
from ogame_bot.lib.ogame import BAD_RESEARCH_ID, BAD_DEFENSE_ID, BAD_SHIP_ID, BAD_BUILDING_ID
from ogame_bot.lib.ogame import constants
from ogame_bot.lib.ogame.constants import Resources, Prices, Ships, Defenses
