...
from old_python.ogame_bot.lib.ogame import BAD_RESEARCH_ID, BAD_DEFENSE_ID, BAD_SHIP_ID, BAD_BUILDING_ID
from old_python.ogame_bot.lib.ogame import constants
from old_python.ogame_bot.lib.ogame import Resources, Prices, Ships, Defenses
